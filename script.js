document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isAdminMode) {
        ...
        function renderAddItemForm() {
            ...
            formContainer.innerHTML = `
                ...
                <div class="form-group">
                    ...
                    <textarea id="item-description" rows="4" style="width: 95%;" placeholder="아이템에 대한 설명을 입력하세요."></textarea>
                </div>
        ...
        function handleGenerateItemCode() {
            ...
            const stats = {
                'HP': parseInt(document.getElementById('item-hp').value) || 0,
                '스피드': parseInt(document.getElementById('item-speed').value) || 0,
                '공격': parseInt(document.getElementById('item-attack').value) || 0,
                '방어': parseInt(document.getElementById('item-defense').value) || 0,
                '특수공격': parseInt(document.getElementById('item-sp-attack').value) || 0,
                '특수방어': parseInt(document.getElementById('item-sp-defense').value) || 0,
            };
