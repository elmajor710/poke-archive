document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeAppUserMode() {
        ...
        function renderPokemonView(contentDiv, data, menuId) {
            ...
            let statsHTML = '';
            if (data.stats) {
                const totalStats = data.totalStats || Object.values(data.stats).reduce((a, b) => Number(a) + Number(b), 0);
        ...
        function renderCalendarView(contentDiv, data) {
            ...
            function buildCalendar(year, month) {
                ...
                let html = `...`; // (Full calendar HTML generation logic here)
                calendarView.innerHTML = html;
                
                calendarView.addEventListener('click', (e) => {
                    // (Full calendar navigation and modal logic here)
                });
                return calendarView;
            }
