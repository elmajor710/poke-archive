const DB = {
    ...
    pokemonType: {
        ...
        lev4: {
            regigigas: {
                name: '레지기가스', grade: 'S+', imageURL: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/486.png',
                stats: { 'HP': 110, '스피드': 100, '공격': 160, '방어': 110, '특수공격': 80, '특수방어': 110 },
                skills: { active: '엄청난힘', ultimate: '기가임팩트', passive: '슬로스타트' },
                recommendedItems: [ { id: 'leftovers', name: '먹다남은음식', imageURL: '이미지URL_준비중', reason: 'HP를 회복하여 안정성을 높입니다.' } ],
                recommendedRunes: [ { id: 'kingKong', name: '금강 룬', imageURL: '이미지URL_준비중', reason: '공격력을 극대화합니다.' } ],
                recommendedChips: [ { id: 'loneWolf', name: '늑대대행자 칩', imageURL: '이미지URL_준비중', reason: '단일 공격 능력을 강화합니다.' } ]
            },
    ...
    pokemonGrade: {
        ...
        lev3: { }, // 스크립트가 자동으로 채울 것이므로 비워둡니다.
        lev4: { }  // 스크립트가 'pokemonType.lev4'의 데이터를 참조하므로 비워둡니다.
    },
    ...
    runeAndChip: {
        ...
        lev3: { rune: [ { id: 'deadly', name: '치명 / Deadly' } ], chip: [ { id: 'loneWolf', name: '늑대대행자 / Lone Wolf' } ] },
        lev4: {
    ...
    deck: {
        ...
        lev3: { 
            newbieDeck: { 
                name: '극초반 뉴비 (S급 8마리)', imageURL: '이미지URL_준비중',
    ...
    calendar: {
        ...
        lev3: { 
            gachaSchedule: { 
                ...
                events: [
                    // 랭킹뽑기 데이터
                    { date: '2025-07-18', title: '웅의 메가 강철톤(강철/땅)[무쇠 바퀴]', type: 'ranking' },
                    { date: '2025-08-22', title: '코라이돈(격투/드래곤)[애프룡]', type: 'ranking' },
                    { date: '2025-09-26', title: '메가 보만다(드래곤/비행)[고동치는달]', type: 'ranking' },
                    { date: '2025-10-31', title: '이로치 메가 핫삼(벌레/강철)[사마자르]', type: 'ranking' },
                    { date: '2025-12-05', title: '디아루가 오리진폼(강철/드래곤)[브리두라스]', type: 'ranking' },
                    { date: '2026-01-09', title: '이로치 메가 헤라크로스(벌레/격투)[땅을 기는 날개]', type: 'ranking' },
                    { date: '2026-02-13', title: '이로치 메가 쁘사이저 (벌레/비행)[꼬시레]', type: 'ranking' },
                    // 한정뽑기 데이터
                    { date: '2025-06-27', title: '이로치 메가 눈설왕, 이로치 메가 이상해꽃', type: 'limited' },
                    { date: '2025-08-01', title: '무한다이노, 미라이돈', type: 'limited' },
                    { date: '2025-09-05', title: '이로치 메가 나무킹, 챔피언 피카츄', type: 'limited' },
                    { date: '2025-10-10', title: '이로치 메가 이상해꽃, 웅의 메가 강철톤', type: 'limited' },
                    { date: '2025-11-14', title: '미라이돈, 코라이돈', type: 'limited' },
                    { date: '2025-12-19', title: '챔피언 피카츄, 메가보만다', type: 'limited' },
                    { date: '2026-01-23', title: '웅의 메가 강철톤, 이로치 메가 핫삼', type: 'limited' },
                    { date: '2026-02-27', title: '코라이돈, 디아루가 오리진폼', type: 'limited' },
                    { date: '26-04-03', title: '메가보만다, 이로치 메가 헤라크로스', type: 'limited' }, // YYYY-MM-DD 형식으로 변환 필요
                    { date: '26-05-08', title: '이로치 메가 핫삼, 이로치 메가 쁘사이저', type: 'limited' }  // YYYY-MM-DD 형식으로 변환 필요
                ]
            } 
        }
    },
    ...
    tips: {
        ...
        lev3: { 
            beginnerTop10: { 
                ...
                content: '<h3>1. 리세마라 가이드</h3><p>리세마라는 ... 하는 것이 좋습니다.</p>'
            },
        }
    }
};