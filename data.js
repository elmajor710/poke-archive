const DB = {
    ...
    item: {
        ...
        lev3: { 
            god: [ {id:'Immortal Sword_God', name:'녹슨검/Immortal Sword'} ],
            legendary: [
        ...
        lev4: {
            'Immortal Sword_God': { name: '녹슨검 (God)', grade: 'God', imageURL: 'https://raw.githubusercontent.com/elmajor710/poke-asserts/main/immortal-sword-god.png', description: '자시안에게 지니게 하면 전투 중에 검왕의 모습으로 변신한다.'},
            ...
            'basicattributes1': { name: '유명 독핵/Basic Attributes', grade: 'Legendary', imageURL: 'https://raw.githubusercontent.com/elmajor710/poke-asserts/main/Basic%20Attributes.png', description: '상세 설명이 필요합니다.'},
            'basicattributes2': { name: '강자 엔진/Basic Attributes', grade: 'Legendary', imageURL: 'https://raw.githubusercontent.com/elmajor710/poke-asserts/main/Basic%20Attributes.png', description: '상세 설명이 필요합니다.'},
