const DB = {
    ...
    // ▼▼▼ [2차 개발] '공지사항' 데이터 구조 신규 추가 ▼▼▼
    notice: {
        lev2: [
            { id: 'notice_02', name: '[업데이트] 신규 포켓몬 추가 (2025-08-10)', date: '2025-08-10' },
            { id: 'notice_01', name: '[공지] 사이트 이용 안내 (2025-08-01)', date: '2025-08-01' }
        ],
        lev3: {
            'notice_01': { title: '[공지] 사이트 이용 안내 (2025-08-01)', htmlContent: `<h3>Nirvana's Poke-Archive에 오신 것을 환영합니다.</h3><p>본 사이트는 포켓몬 육성 정보를 공유하기 위해 만들어졌습니다.<br>다양한 정보를 좌측 메뉴를 통해 확인하실 수 있습니다.</p><p>앞으로 많은 이용 부탁드립니다. 감사합니다.</p>` },
            'notice_02': { title: '[업데이트] 신규 포켓몬 추가 (2025-08-10)', htmlContent: `<h3>신규 SS등급 포켓몬이 추가되었습니다.</h3><p>포켓몬 타입 및 등급 메뉴에서 확인하실 수 있습니다.</p><ul><li>메가 디안시</li><li>굴레를 벗어난 후파</li></ul>` }
        }
    },
    // ▲▲▲ [2차 개발] '공지사항' 데이터 구조 신규 추가 ▲▲▲
